			             ...
			             <form id="frm-example" action="/path/to/your/script" method="POST">
		            		<div class="table-responsive">
					            <table id="zeitschriften" class="table table-bordered table-striped display table-hover">
					                <thead>
						                <tr>
						                	<th class="rowlink-skip dt-body-center"><!-- <input type="checkbox" name="select_all" value="1" id="example-select-all">  --><button class="btn btn-danger btn-sm delete-row"  title="Löschen"><i class="fa fa-trash"></i></button></th>
											<th>Kürzel</th>
											<th>Titel</th>
											<th>Jahr</th>
											<th>Band</th>
