  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class=""> <a href="<?php echo $absoluteUrl;?>stammdaten/arzeneien">Arzeneien</a></li>
        <li class="active"> Neu Arznei</li>
      </ol>
    </section>
		              	...
		              	<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="arzeneien">Arznei*</label><span class="error-text"></span>
									<input type="text" class="form-control" id="arzeneien" name="code" required autofocus>
								</div>
								<div class="form-group">
