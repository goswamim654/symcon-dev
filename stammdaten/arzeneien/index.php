			...
			<div class="col-md-12">
				<div class="box box-success">
		            <div class="box-header with-border">
		              <h3 class="box-title">
		              	<a href="<?php echo $absoluteUrl;?>stammdaten/arzeneien/add.php" class="btn btn-success"><i class="fa fa-plus"></i> &nbsp; Neu Arzeneien</a>
		              </h3>
		            </div>
		            <!-- /.box-header -->
		            <div class="box-body">
			            <form id="frm-example" action="/path/to/your/script" method="POST">
		            		<div class="table-responsive">
					            <table id="arzeneien" class="table table-bordered table-striped display table-hover">
					                <thead>
						                <tr>
