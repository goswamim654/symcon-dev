		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-success">
		            ...
		            <!-- /.box-header -->
		            <!-- form start -->
		            <form role="form" class="formValid content-form" id="addArzneiForm" autocomplete="off"data-value="update" data-type="arznei" data-id="<?php echo $arzneien['arznei_id'];?>" data-idtype="arznei">
		              <div class="box-body">
		              	<div class="row">
							<div class="col-md-6">
